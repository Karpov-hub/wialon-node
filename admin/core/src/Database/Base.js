        ...
        [   
            ...
            ,function(filters, call) {
                ...
                if(q) {  
                    ...
                    Ext.clone(model.fields).prepEach((field, nxt) => {
                        if(field.filterable && (!params.fieldSet || params.fieldSet.indexOf(field.name) != -1) && field.type == 'string') {
     
                            var x = me.fieldTypes[field.type].getFilterValue(null, {value: q._value, operator: 'like'}, field.name, function(cond) {
                                find.$or.push(cond)
                                nxt()
                            })                             
                        } else
