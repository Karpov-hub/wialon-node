...
Ext.define('Admin.Data',{
    ...
    ,$getFile: function() {
        ...
        if(me.params.gpc.name) {  
            ...
            if(me.params.gpc.file)
                path = me.config.userFilesDir + '/' + me.params.gpc.file
    ...
    ,$getTmpImage: function() {
        var me = this;        
        if(me.params.gpc.tmp) {  
            var path = me.config.uploadTmpDir + '/' + me.params.gpc.tmp
            fs.readFile(path, function(e, data) {
                if(data) {
                    me.sendImage(data, me.params.gpc.format || 'png')
                }
            })
        }
    }
