...
class Report extends Base {
    //16. Пробег с началом и концом движения ТС ТОО  «Каражанбасмунай», создан с помощью Repogen.
  ...
  async generateReportTemplate(resourceId) {
    var generateReportParams = 
    {
        ...
        "itemId": resourceId,
        "callMode": "create",
        "n":"16. Пробег с началом и концом движения ТС ТОО  «Каражанбасмунай», создан с помощью Repogen.",
        "ct":"avl_unit_group",
        ...
        "tbl":[
          ...
          },
          {
            "n":"unit_group_trips",
            "l":"Поездки",
            "c":"[\"user_column\",\"time_begin\",\"time_end\",\"mileage\",\"fuel_consumption_fls\"]",
            "cl":"[\"Группа/ Автоколонна\",\"Начало движения\",\"Конец движения\",\"Проиденное расстояние\",\"Расход ГСМ\"]",
  ...
  make(xlsxData) {
    ...
    xlsxData.forEach((row) => {
      this.insertOneTable("Пробег с началом и концом движения",row.data, row.headers, row.total, styles);
    })
  }
}
