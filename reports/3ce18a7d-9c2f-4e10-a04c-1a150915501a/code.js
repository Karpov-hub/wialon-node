...
class Report extends Base {
    //19. Отчет по выявленным нарушениям ТС ТОО  «Каражанбасмунай»
  ...
  async generateReportTemplate(resourceId) {
    var generateReportParams = 
    {
        ...
        "itemId": resourceId,
        "callMode": "create",
        "n":"19. Отчет по выявленным нарушениям ТС ТОО  «Каражанбасмунай», создан с помощью Repogen.",
        "ct":"avl_unit_group",
        ...
        "tbl":[
          ...
          },
          {
            ...
            "l":"Нарушения",
            "c":"[\"user_column\",\"evt_text\",\"time\",\"dummy\"]",
            "cl":"[\"Группа/ Автоколонна\",\"Описание нарушения\",\"Дата/Время\",\"Примечание\"]",
  ...
  make(xlsxData) {
    ...
    xlsxData.forEach((row) => {
      this.insertOneTable("Отчет по выявленным нарушениям ТС",row.data, row.headers, row.total, styles);
    })
  }
}
