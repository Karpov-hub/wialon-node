...
class Report extends Base {
    //22. Ежедневное отработанное время за вторую смену ТС ТОО  «Каражанбасмунай»
  ...
  async generateReportTemplate(resourceId) {
    var generateReportParams = 
    {
        ...
        "itemId": resourceId,
        "callMode": "create",
        "n":"22. Ежедневное отработанное время за вторую смену ТС ТОО  «Каражанбасмунай», создан с помощью Repogen.",
        "ct":"avl_unit_group",
  ...
  make(xlsxData) {
    ...
    xlsxData.forEach((row) => {
      this.insertOneTable("Ежедневное отработанное время за вторую смену",row.data, row.headers, row.total, styles);
    })
  }
}
