...
class Report extends Base {
    //10. Максимальная скорость АТТ АО  «Каражанбасмунай»
  ...
  async generateReportTemplate(resourceId) {
    var generateReportParams = 
    {
      ...
      "itemId": resourceId,
      "callMode": "create",
      "n":"10.1 Максимальная скорость АТТ АО  «Каражанбасмунай» дор, создан с помощью Repogen.",
      "ct":"avl_unit_group",
      ...
      "tbl":[
        ...
        },
        {
          ...
          "c":"[\"user_column\",\"max_speed\",\"time_begin\"]",
          "cl":"[\"Группа/ Автоколонна\",\"Скорость\",\"Время\"]",
  ...
  make(xlsxData) {
    ...
    xlsxData.forEach((row) => {
      this.insertOneTable("Максимальная скорость",row.data, row.headers, row.total, styles);
    })
  }
}
