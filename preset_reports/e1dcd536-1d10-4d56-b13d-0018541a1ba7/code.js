...
class Report extends Base {
    //15. Пробег ТС ТОО «Каражанбасмунай»
  ...
  async generateReportTemplate(resourceId) {
    var generateReportParams = 
    {
        ...
        "itemId":resourceId,
        "callMode": "create",
        "n":"15. Пробег ТС ТОО «Каражанбасмунай», создан с помощью Repogen.",
        "ct":"avl_unit_group",
        ...
        "tbl":[
          ...
          },
          {
            "n":"unit_group_trips",
            "l":"Поездки",
            "c":"[\"user_column\",\"mileage\",\"fuel_consumption_fls\"]",
            "cl":"[\"Группа/ Автоколонна\",\"Пройденное расстояние\",\"Расход ГСМ\"]",
  ...
  make(xlsxData) {
    ...
    xlsxData.forEach((row) => {
      this.insertOneTable("Пробег ",row.data, row.headers, row.total, styles);
    })
  }
}
